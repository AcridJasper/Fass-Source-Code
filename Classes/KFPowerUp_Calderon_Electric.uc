class KFPowerUp_Calderon_Electric extends KFPowerUp;
...
DefaultProperties
{
	...
	SecondaryDamageType=class'KFDT_Electric_Calderon'
	SecondaryDamage=30

	CameraLensEffectTemplate=class'KFCameraLensEmit_PowerUp_Calderon_Electric'
	PowerUpEffect=ParticleSystem'Fass_EMIT.FX_CHR_Calderon_Electric'
}