class KFPowerUp_Calderon_Toxin extends KFPowerUp;
...
DefaultProperties
{
	...
	SecondaryDamageType=class'KFDT_Toxin_Calderon'
	SecondaryDamage=30

	CameraLensEffectTemplate=class'KFCameraLensEmit_PowerUp_Calderon_Toxin'
	PowerUpEffect=ParticleSystem'Fass_EMIT.FX_CHR_Calderon_Toxin'
}