class KFPowerUp_Calderon_Heat extends KFPowerUp;
...
DefaultProperties
{
	...
	SecondaryDamageType=class'KFDT_Heat_Calderon'
	SecondaryDamage=30

	CameraLensEffectTemplate=class'KFCameraLensEmit_PowerUp_Calderon_Heat'
	PowerUpEffect=ParticleSystem'Fass_EMIT.FX_CHR_Calderon_Heat'
}